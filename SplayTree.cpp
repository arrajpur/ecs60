...
void SplayTree<Comparable>::printTree( SplayBinaryNode<Comparable> *t ) const
{
  ...
  {
    printTree( t->left );
    cout << t->element.getPacketNum() << ": " << t->element.getPacket() << endl;
    printTree( t->right );
  }
}*/
...
/*template <class Comparable>
bool SplayTree<Comparable>::operator<(SplayTree & comp) const
{
...
template <class Comparable>
int SplayTree<Comparable>::getPortNum() const
{
  return portNum;
}
// returns tcp, containing either port number or the last packet through
*/